    ...
    <div className="mt-2 space-y-0.5">
      {papers.map((paper) => (
        <div key={paper.id} className="flex items-start gap-1.5">
          <span className="text-blue-400 text-[8px] mt-0.5">●</span>
          <a
            href={paper.url}
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs text-blue-600 hover:text-blue-800 hover:underline bg-blue-50 px-1.5 py-0.5 rounded inline-block max-w-full truncate"
